...
Object.assign(EN_DICT, {
  ...
  "按顺序完成：①环境检查 → ②SSH 密钥与连接 → ③代码管理，以及 ④克隆仓库 / ⑤提交 PR / ⑥发布 npm 包。推送会自动忽略 >100MB 的文件（": "In order: ①Environment → ②SSH key & connection → ③Code management, plus ④Clone repos / ⑤Pull Request / ⑥Publish npm. Pushing auto-ignores >100MB files (",
		...
		function ScmPanel({ onClose, variant }) {
			...
			return h("div", { style: panelStyle(variant), role: "dialog", "aria-modal": embedded ? undefined : "true", "aria-label": t("源代码管理") },
				...
				h("p", { style: { margin: "6px 0 14px", color: T.secondary, fontSize: 12, lineHeight: 1.6 } },
					t("按顺序完成：①环境检查 → ②SSH 密钥与连接 → ③代码管理，以及 ④克隆仓库 / ⑤提交 PR / ⑥发布 npm 包。推送会自动忽略 >100MB 的文件（") + (provider === "gitee" ? "Gitee" : "GitHub") + t(" 限制）并说明原因。")),
				h(EnvSection, null),
